...
app.use(logger('dev'));
app.use(cache('1 second', onlyStatus200))
...
app.use('/yuyinshibie', require('./router/yuyinshibie'))

app.use('/pythonsearch', require('./router/pythonplayer'))

app.use('/pythonpause', require('./router/musicpause'))
